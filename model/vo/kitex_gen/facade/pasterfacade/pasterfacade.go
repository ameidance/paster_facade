...
func serviceInfo() *kitex.ServiceInfo {
	return pasterFacadeServiceInfo
}

var pasterFacadeServiceInfo = newServiceInfo()

func newServiceInfo() *kitex.ServiceInfo {
	serviceName := "PasterFacade"
	handlerType := (*facade.PasterFacade)(nil)
...
func getPostHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(facade.PasterFacade).GetPost(ctx, req)
		if err != nil {
			return err
		}
	...
	case *GetPostArgs:
		success, err := handler.(facade.PasterFacade).GetPost(ctx, s.Req)
		if err != nil {
			return err
		}
...
func savePostHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(facade.PasterFacade).SavePost(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *SavePostArgs:
		success, err := handler.(facade.PasterFacade).SavePost(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getCommentsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(facade.PasterFacade).GetComments(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetCommentsArgs:
		success, err := handler.(facade.PasterFacade).GetComments(ctx, s.Req)
		if err != nil {
			return err
		}
...
func saveCommentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(facade.PasterFacade).SaveComment(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *SaveCommentArgs:
		success, err := handler.(facade.PasterFacade).SaveComment(ctx, s.Req)
		if err != nil {
			return err
		}
...
func checkHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(facade.PasterFacade).Check(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *CheckArgs:
		success, err := handler.(facade.PasterFacade).Check(ctx, s.Req)
		if err != nil {
			return err
		}
...
func watchHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	stream := &pasterFacadeWatchServer{st}
	req := new(facade.HealthCheckRequest)
	if err := st.RecvMsg(req); err != nil {
		return err
	}
	return handler.(facade.PasterFacade).Watch(req, stream)
}

type pasterFacadeWatchClient struct {
	streaming.Stream
}

func (x *pasterFacadeWatchClient) Recv() (*facade.HealthCheckResponse, error) {
	m := new(facade.HealthCheckResponse)
	return m, x.Stream.RecvMsg(m)
}

type pasterFacadeWatchServer struct {
	streaming.Stream
}

func (x *pasterFacadeWatchServer) Send(m *facade.HealthCheckResponse) error {
...
func (p *kClient) Watch(ctx context.Context, req *facade.HealthCheckRequest) (PasterFacade_WatchClient, error) {
	...
	stream := &pasterFacadeWatchClient{res.Stream}
